...
{
    public partial class frmProfilGüncelleme : Form
    {
        DbProcess db = new DbProcess("CafeProject");
        public frmProfilGüncelleme()
        {
            InitializeComponent();
        }
        int id = 0;
        public frmProfilGüncelleme(int id)
        {
            InitializeComponent();
            this.id = id;
        }
        ...
        private void frmProfilGüncelleme_Load(object sender, EventArgs e)
        {
